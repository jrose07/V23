...
\begin{figure}[H]
        ...
        \caption{Skizze des Schaltbildes. ~\cite{Durchfuehrung}}
\end{figure}
...
Außerdem gibt es Zwischenringe zur Aufbrechung der Kugelsymmetrie.
\begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{content/pics/Auf.png}
        \caption{Baukasten des Versuchaufbaus. ~\cite{Durchfuehrung}}
\end{figure}
...
Die Messung wird solange mit einem weiteren \qty{75}{mm} Zylinder wiederholt, bis die Schiene voll ist. 
