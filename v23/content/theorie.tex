...
\begin{equation*}
    (\Delta + k^2)p = 0, 
\end{equation*}
das $\Delta$ ist der Laplace-Operator, das $k$ der Wellenvektor und das $p$ ist die ortsabhängige Amplitude des Schalldrucks. 
...
\end{equation*}
Stehende Wellen können sich nur bilden, wenn ein Vielfaches ihrer in den Hohlraumresonator passt. Hierbei stößt die Welle bei $r = R_k$ auf eine Wand. 
...
\begin{equation*}
    k^2 = k_r^2+k_z^2, 
\end{equation*}
wobei $k_z = \frac{\pi l}{L}$ und $k_r = \frac{\eta_{mnl}}{R_z}$ für die k's eingesetzt werden, damit folgt 
\begin{equation*}
